                ...
                <div className="main-container">
                    ...
                    <div className="flex-container">
                        <div>
                            ...
                            <h1><span className="font-weight-lg">{weatherData.temp}</span><span>°C</span></h1>
                            <h5><span>feels like: {weatherData.feelslike}</span><span>°C</span></h5>
                        </div>
                    </div>
                    ...
                    <div className="flex-container">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>{weatherData.windspeedKnot} knots | {weatherData.windspeedKmH} km/h</td>
                            </tr>
                            <tr>
                                <td className="font-weight-lg">Wind direction:</td>
                                <td><WindDirection weatherData={this.props.weatherData}/></td>
                            </tr>
                            </tbody> 
                        </table>
